...
| 模块 | 功能 |
|------|------|
| 起卦 | 时间起卦、数字起卦、铜钱起卦、手动起卦、**物理引擎摇铜钱**、**环境感知起卦** |
| 解卦 | 卦象展示、卦辞解读、AI智能解读（可选）、**AI角色扮演** |
| 历史 | 记录保存、搜索筛选、导出备份 |
| 仪表盘 | **运势可视化**、**统计分析图表** |
...
1. 安装 [Ollama](https://ollama.ai)（需要 Ollama v0.17.5+）
...
### v1.3.0 (2026-03-04)
- ✨ 物理引擎铜钱起卦（Matter.js 2D物理模拟）
- ✨ 环境感知起卦（天气API集成、环境音推荐）
- ✨ AI角色扮演解卦（智者、学者、大师等多角色、多轮对话）
- ✨ 运势可视化仪表盘（ECharts图表、统计分析）
